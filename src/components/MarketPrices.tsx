...
      
      // Updated mock data for Maharashtra, focusing on Dahanu (Palghar District) and nearby APMCs
      const mockPrices: MarketPrice[] = [
        {
          commodity: 'Chikoo (Sapota)', // Dahanu is famous for Chiku
          price: 65,
          unit: 'per kg',
          trend: 'up',
          change: 8,
...
          price: 2100, // Price per quintal (100 kg)
          unit: 'per Quintal',
          trend: 'stable',
          change: 0,
          market: 'Palghar APMC',
...
    <div className="max-w-4xl mx-auto p-6 bg-white rounded-xl shadow-lg">
      <div className="mb-6">
        <h2 className="text-2xl font-bold text-gray-800 mb-2">बाजार भाव (Market Prices)</h2>
        <p className="text-gray-600">Current prices from Maharashtra APMCs (Dahanu/Palghar region)</p>
      </div>
...
      {/* Price Alert - Updated for Dahanu's famous Chiku */}
      <div className="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
        <h4 className="font-semibold text-blue-800 mb-2">Price Alert: Chikoo</h4>
        <p className="text-blue-700 text-sm">
          Chikoo (Sapota) prices have increased by 8% at Dahanu APMC recently. Good time for harvest and sale!
        </p>
      </div>
    </div>
  );
