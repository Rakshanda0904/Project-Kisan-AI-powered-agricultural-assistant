...
    
    // Data tailored for Maharashtra/Palghar region
    const mockDrones: DroneData[] = [
      {
        id: '1',
        name: 'Palghar AgriScout',
        status: 'active',
        battery: 78,
        // Approximate coordinates for Palghar district
        location: { lat: 19.6890, lng: 72.7669 },
        currentTask: 'Chikoo Orchard Surveillance',
        coverage: 65,
...
            type: 'pest',
            severity: 'medium',
            location: 'Gholvad Orchard - Block C',
            description: 'White Scale (Pseudaulacaspis) infestation detected on lower branches of Chikoo trees.',
            image: 'https://images.pexels.com/photos/4481259/pexels-photo-4481259.jpeg'
          },
          {
            type: 'irrigation',
            severity: 'high',
            location: 'Rice Paddy - Zone A',
            description: 'Water level below optimal for paddy cultivation, severe dry patches visible.',
...
      {
        id: '2',
        name: 'Dahanu AirWatch',
        status: 'charging',
        battery: 15,
        location: { lat: 19.9808, lng: 72.8273 }, // Approximate coordinates for Dahanu
        currentTask: 'Charging at Dahanu Farm Base',
        coverage: 100,
...
            type: 'growth',
            severity: 'low',
            location: 'Tomato Plot - Section D5',
            description: 'Optimal growth uniformity observed across the tomato canopy.',
...
          />
          <p className="mt-4 text-gray-600">Connecting to drone fleet (Maharashtra operations)...</p>
        </div>
      </div>
    );
  }
...
      <div className="mb-6">
        <h2 className="text-2xl font-bold text-gray-800 mb-2">🚁 Drone Monitoring System (Maharashtra)</h2>
        <p className="text-gray-600">Real-time aerial surveillance and crop monitoring for local farms.</p>
      </div>
---
...
                    alt="Drone aerial view of Maharashtra farm"
...
                        <span>{selectedDrone.location.lat}°N, {selectedDrone.location.lng}°E</span>
                      </div>
                      <div className="flex items-center space-x-1">
...
                <h3 className="text-xl font-semibold text-gray-800 mb-4">🔍 Recent Findings (Scanned Area)</h3>
                
